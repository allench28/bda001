...
from constants import get_claude_anthropic_media_type
...
def promptBedrock(prompt_data, file_data=None, file_type=None):
    # Create message content with both text and file data if provided
    content = create_message_content(prompt_data, file_data, file_type)
...
@tracer.capture_method
def create_message_content(prompt_data, image_data=None, file_extension=None):
    content = []
